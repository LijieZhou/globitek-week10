<?php
  ...
  //After each failed attempt to login, either update an exsiting record
  //or create a new record for the username if non-exisits
  ...
  //reset the falied_login's count to 0
